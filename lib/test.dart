          ...
          child: SafeArea(
            child: Column(
              children: [
                ...
                const Align(
                  alignment:
                      Alignment(-0.9, 0.0), // Horizontal and vertical alignment
                  child: Text(
                    "Today's Playlist !",
                    style: TextStyle(
                      fontSize: 20,
                              ...
                              child: Column(
                                ...
                                children: [
                                  SizedBox(
                                    height: 150,
                                    width: 150,
                                    // Adjust size for Lottie animation
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      cardText[index], // Add text from the list
                ...
                //       return  music_card(name: ms['Name'] as String,artist:ms['Artist'] as String,image: ms['img'] as String);
                //     },
                //   ),
                // )
              ],
